...
### Prerequisites
You should have [Reshade](https://reshade.me) (preferably the latest) and at least reshade.fxh present in the `reshade-shaders\shaders` folder
...
I recommend to test out activating each shader file individually in batches for which ever program/game you intend to run. 
